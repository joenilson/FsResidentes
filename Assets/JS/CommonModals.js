 ...
 * @param {string} size
 */
function executeModal(modalId, title, content, contentType = 'default', saveButtonCallback = '', size = 'small')
{
    //Set the modal ID
...
function setModalContentType(contentType, content)
{
    if (contentType === 'default') {
        ...
        return '<div class="alert alert-' + contentType + '" role="alert"> ' + content + '</div>';
    }
}
...
function setModalButtons(contentType, saveButtonCallback)
{
    ...
    const infoButton  = '<button type="button" class="btn btn-info" data-bs-dismiss="modal">Cerrar</button>';
    ...
    const confirmButton  = '<button type="button" class="btn btn-primary"' +onClick+'>Confirmar</button>';
